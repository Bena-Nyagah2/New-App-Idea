...
export function TikTokIcon({ size = 20, className }: SocialIconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.59 3.13-5.91 3.15-1.43.07-2.86-.31-4.08-1.03-2.02-1.19-3.34-3.43-3.39-5.81-.02-.36-.02-.73.01-1.09.28-2.3 2.06-4.33 4.3-4.86 1.63-.4 3.39-.04 4.75 1.01.04-1.46.02-2.92.03-4.38.01-1.92-.02-3.84.02-5.76h3.85z" />
    </svg>
  );
}
