...
DROP INDEX "orders_mpesa_receipt_number_unique";--> statement-breakpoint
DROP INDEX "orders_checkout_request_id_unique";--> statement-breakpoint
...
ALTER TABLE `orders` ALTER COLUMN "payment_method" TO "payment_method" text NOT NULL DEFAULT 'mpesa';--> statement-breakpoint
...
CREATE UNIQUE INDEX `orders_mpesa_receipt_number_unique` ON `orders` (`mpesa_receipt_number`);--> statement-breakpoint
...
ALTER TABLE `orders` ALTER COLUMN "created_at" TO "created_at" integer NOT NULL DEFAULT '"2026-07-16T21:47:12.158Z"';--> statement-breakpoint
ALTER TABLE `orders` ALTER COLUMN "updated_at" TO "updated_at" integer NOT NULL DEFAULT '"2026-07-16T21:47:12.158Z"';--> statement-breakpoint
ALTER TABLE `orders` ADD `mpesa_receipt_number` text;--> statement-breakpoint
ALTER TABLE `orders` ADD `mpesa_phone_number` text;--> statement-breakpoint
ALTER TABLE `orders` ADD `checkout_request_id` text;--> statement-breakpoint
ALTER TABLE `orders` ADD `paid_at` integer;--> statement-breakpoint
ALTER TABLE `payouts` ALTER COLUMN "created_at" TO "created_at" integer NOT NULL DEFAULT '"2026-07-16T21:47:12.159Z"';--> statement-breakpoint
ALTER TABLE `products` ALTER COLUMN "created_at" TO "created_at" integer NOT NULL DEFAULT '"2026-07-16T21:47:12.156Z"';--> statement-breakpoint
ALTER TABLE `products` ALTER COLUMN "updated_at" TO "updated_at" integer NOT NULL DEFAULT '"2026-07-16T21:47:12.156Z"';--> statement-breakpoint
ALTER TABLE `settings` ALTER COLUMN "updated_at" TO "updated_at" integer NOT NULL DEFAULT '"2026-07-16T21:47:12.159Z"';--> statement-breakpoint
ALTER TABLE `suppliers` ALTER COLUMN "created_at" TO "created_at" integer NOT NULL DEFAULT '"2026-07-16T21:47:12.158Z"';--> statement-breakpoint
ALTER TABLE `variants` ALTER COLUMN "created_at" TO "created_at" integer NOT NULL DEFAULT '"2026-07-16T21:47:12.157Z"';--> statement-breakpoint
ALTER TABLE `variants` ALTER COLUMN "updated_at" TO "updated_at" integer NOT NULL DEFAULT '"2026-07-16T21:47:12.157Z"';